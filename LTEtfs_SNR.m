...
numSNRTypes = length(SNRs);
  ...
  modClassNet = [
  sequenceInputLayer([1 spf_tf 2],'Name','input')    
...
frameStore = helperModClassFrameStore(...
  numFramesPerSNRType*numSNRTypes*numModulationTypes*numDopplerTypes*numDelayTypes,spf_tf,SNRTypes);
...
rxTrainingArr = zeros(1, spf_tf, 2, WINDOWS(window));
...
rxValidationArr = zeros(1, spf_tf, 2, WINDOWS(window));
...
rxTestArr = zeros(1, spf_tf, 2, WINDOWS(window));
...
% Swindow: 1 SNR: 23   Accuracy: 98.8889
% Swindow: 1 SNR: 24   Accuracy: 92.5926
% Swindow: 1 SNR: 25   Accuracy: 39.6296
% Swindow: 1 SNR: 26   Accuracy: 0
% Swindow: 1 SNR: 27   Accuracy: 0
%  window: 1Mean accuracyS: 90.0412
